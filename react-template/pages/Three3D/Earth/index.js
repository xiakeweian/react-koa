...
// 创建场景，创建摄像机，创建渲染器，设置渲染器color,设置渲染器大小，将渲染器添加到dom中，
// 创建几何体，创建材质，创建光源，将光源添加到场景中，
// 渲染器中渲染场景和摄像机，renderer.render(scene,camera)
// 添加loader,添加轨道控制器
  ...
  initThree = () => {
    ...
    function init() {
      ...
      loader.load(earthModel, function(mesh) {
        ...
        mesh.scene.scale.set(0.25, 0.25, 0.25);
        earth = mesh.scene;
        scene.add(earth);
      });
